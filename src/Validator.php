...
class Validator
{
    ...
    private $messages = [
        ...
        "formatitre" => "Le champ peut contenir que des lettres minuscules et accentuer ,majuscules et accentuer , apostrophe et espace !",
        "formatext" => "Le champ peut contenir que des lettres minuscules et accentuer ,majuscules et accentuer , apostrophe, virgule et espace !",
        "alphaNum" => "Le champ peut contenir que des lettres minuscules, majuscules et des chiffres !",
        "alphaNumSpace" => "Le champ peut contenir que des lettres minuscules, majuscules des chiffres et des espace !",
        "alphaNumDash" => "Le champ peut contenir que des lettres minuscules, majuscules, des chiffres, des slash et des tirets !",
        "alphaNumDashSpace" => "Le champ peut contenir que des lettres minuscules, majuscules, des chiffres, des slash, des tirets et des espace !",
    ...
    private $rules = [
        ...
        "alpha" => "#^[A-z]+$#",
        "formatitre" => '#^([[a-zA-Z\' ]|[à-ú]|[À-Ú]])+$#',
        "formatext" => '^([[a-zA-Z\'\,\- ]|[à-ú]|[À-Ú]])+$',
        "alphaNum" => "#^[A-z0-9]+$#",
        'alphaNumSpace' => '#^[A-z0-9 ]+$#',
        "alphaNumDash" => "#^[A-z0-9-\|]+$#",
        "alphaNumDashSpace" => '#^[A-z0-9-\ |]+$#',
        "numeric" => "#^[0-9]+$#",
        "confirm" => ""
    ];
